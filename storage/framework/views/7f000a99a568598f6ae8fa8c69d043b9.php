    ...
    <div class="card shadow-sm">
        <div class="card-body">
            ...
            <form action="<?php echo e(route('admin.stock_adjustments.store')); ?>" method="POST">
                ...
                <a href="<?php echo e(route('admin.stock_adjustments.index')); ?>" class="bg-blue-600 text-white px-6 py-4 mx-4 rounded hover:bg-blue-700"><i class="fas fa-arrow-left"></i> Back to Logs</a>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\electronics-store-app - Copy\electronics-store-app - Copy\resources\views/admin/stock_adjustments/create.blade.php ENDPATH**/ ?>