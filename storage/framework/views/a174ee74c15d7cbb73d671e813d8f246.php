            ...
            <tbody class="divide-y divide-gray-100">
                <?php $__empty_1 = true; $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <tr class="hover:bg-blue-50/50 transition duration-150 ease-in-out group">
                        ...
                        <td class="p-4 text-gray-500 font-mono text-sm">#<?php echo e($category->id); ?></td>
                            ...
                            <?php if($imageSrc): ?>
                                ...
                                <div class="rounded overflow-hidden shadow-sm border border-gray-200 group-hover:border-blue-200 transition" 
                                    ...
                                    <img src="<?php echo e($imageSrc); ?>" 
                                         ...
                                         onclick="openImageModal('<?php echo e($imageSrc); ?>')"
                        ...
                        <td class="p-4">
                            <div class="font-bold text-gray-800"><?php echo e($category->name); ?></div>
                        ...
                        <td class="p-4 text-right">
                            <div class="flex items-center justify-end gap-3">
                                ...
                                <form action="<?php echo e(route('admin.categories.destroy', $category->id)); ?>" 
                                    ...
                                    <button type="submit" 
                                            class="text-gray-400 hover:text-red-600 transition p-1 rounded-full hover:bg-red-50 <?php echo e($category->products_count ? 'opacity-50 cursor-not-allowed' : ''); ?>"
                                            title="Delete"
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\electronics-store-app - Copy\electronics-store-app - Copy\resources\views/admin/categories/index.blade.php ENDPATH**/ ?>