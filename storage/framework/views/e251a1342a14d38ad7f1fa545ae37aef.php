...
<div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
    ...
    <div class="bg-white rounded-xl shadow p-6">
        ...
        <button type="submit"
                class="w-full bg-blue-600 text-white px-6 py-4 rounded hover:bg-blue-700">
            💾 Save
        </button>
    </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\electronics-store-app - Copy\electronics-store-app - Copy\resources\views/cashier/sales/create.blade.php ENDPATH**/ ?>